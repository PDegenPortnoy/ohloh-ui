...
Timeline.Graphics.createBubbleForPoint = function(doc, pageX, pageY, contentWidth, contentHeight) {
    ...
    createImg(urlPrefix + "bubble-top-left.png", 0, 0, margins.left, margins.top);
    createImg(urlPrefix + "bubble-top.png", margins.left, 0, contentWidth, margins.top);
    createImg(urlPrefix + "bubble-top-right.png", margins.left + contentWidth, 0, margins.right, margins.top);

    createImg(urlPrefix + "bubble-left.png", 0, margins.top, margins.left, contentHeight);
    createImg(urlPrefix + "bubble-right.png", margins.left + contentWidth, margins.top, margins.right, contentHeight);

    createImg(urlPrefix + "bubble-bottom-left.png", 0, margins.top + contentHeight, margins.left, margins.bottom);
    createImg(urlPrefix + "bubble-bottom.png", margins.left, margins.top + contentHeight, contentWidth, margins.bottom);
    createImg(urlPrefix + "bubble-bottom-right.png", margins.left + contentWidth, margins.top + contentHeight, margins.right, margins.bottom);
    ...
    setImg(divClose, urlPrefix + "close-button.png", 16, 16);
    ...
    (function() {
        if (pageX - Timeline.Graphics._halfArrowWidth - Timeline.Graphics._bubblePadding > 0 &&
            ...
            if (pageY - Timeline.Graphics._bubblePointOffset - bubbleHeight > 500) { // top semi-hack -- don't show bubbles too high - banner ads get clipped
                ...
                setImg(divImg, urlPrefix + "bubble-bottom-arrow.png", 37, margins.bottom);
                divInner.appendChild(divImg);
                ...
                setImg(divImg, urlPrefix + "bubble-top-arrow.png", 37, margins.top);
                divInner.appendChild(divImg);
        ...
        if (pageX - Timeline.Graphics._bubblePointOffset - bubbleWidth > 0) { // left
            ...
            setImg(divImg, urlPrefix + "bubble-right-arrow.png", margins.right, 37);
            divInner.appendChild(divImg);
            ...
            divImg.style.top = (pageY - Timeline.Graphics._halfArrowWidth - top) + "px";
            setImg(divImg, urlPrefix + "bubble-left-arrow.png", margins.left, 37);
            divInner.appendChild(divImg);
...
Timeline.Graphics.createMessageBubble = function(doc) {
    ...
    if (Timeline.Graphics.pngIsTranslucent) {
        ...
        topDiv.style.background = "url(" + Timeline.urlPrefix + "message-top-left.png) top left no-repeat";
        topDiv.style.paddingLeft = "44px";
        containerDiv.appendChild(topDiv);

        var topRightDiv = doc.createElement("div");
        topRightDiv.style.height = "33px";
        topRightDiv.style.background = "url(" + Timeline.urlPrefix + "message-top-right.png) top right no-repeat";
        topDiv.appendChild(topRightDiv);

        var middleDiv = doc.createElement("div");
        middleDiv.style.background = "url(" + Timeline.urlPrefix + "message-left.png) top left repeat-y";
        middleDiv.style.paddingLeft = "44px";
        containerDiv.appendChild(middleDiv);

        var middleRightDiv = doc.createElement("div");
        middleRightDiv.style.background = "url(" + Timeline.urlPrefix + "message-right.png) top right repeat-y";
        ...
        bottomDiv.style.background = "url(" + Timeline.urlPrefix + "message-bottom-left.png) bottom left no-repeat";
        bottomDiv.style.paddingLeft = "44px";
        containerDiv.appendChild(bottomDiv);

        var bottomRightDiv = doc.createElement("div");
        bottomRightDiv.style.height = "55px";
        bottomRightDiv.style.background = "url(" + Timeline.urlPrefix + "message-bottom-right.png) bottom right no-repeat";
